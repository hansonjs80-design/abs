...
describe('Korean body part normalization', () => {
  it('converts Korean body part names to the standard English labels', () => {
    ...
    assert.equal(toProperCase('안 무릎'), 'Medial Knee');
    assert.equal(toProperCase('무릎 안'), 'Medial Knee');
    assert.equal(toProperCase('팔꿈치 내측'), 'Medial Elbow');
    assert.equal(toProperCase('내측 엘보우'), 'Medial Elbow');
    assert.equal(toProperCase('내측'), 'Medial');
    assert.equal(toProperCase('안쪽'), 'Medial');
    assert.equal(toProperCase('안'), 'Medial');
    ...
    assert.equal(toProperCase('밖 무릎'), 'Lateral Knee');
    assert.equal(toProperCase('무릎 밖'), 'Lateral Knee');
    assert.equal(toProperCase('엘보우 외측'), 'Lateral Elbow');
    assert.equal(toProperCase('외측 어깨'), 'Lateral Shoulder');
    assert.equal(toProperCase('외측'), 'Lateral');
    assert.equal(toProperCase('바깥쪽'), 'Lateral');
    assert.equal(toProperCase('바깥'), 'Lateral');
    assert.equal(toProperCase('밖'), 'Lateral');
    ...
    assert.equal(toProperCase('상과'), 'Epicondylitis');
    assert.equal(toProperCase('상과염'), 'Epicondylitis');
    assert.equal(toProperCase('외측 상과염'), 'Lateral Epicondylitis');
    assert.equal(toProperCase('상과염 내측'), 'Medial Epicondylitis');
  ...
  it('converts Korean direction prefixes without mixing Korean and English output', () => {
    ...
    assert.equal(toProperCase('좌 목'), 'Lt. Cervical');
    assert.equal(toProperCase('좌 고관절'), 'Lt. Hip');
    assert.equal(toProperCase('우 고관절'), 'Rt. Hip');
    ...
    assert.equal(toProperCase('오른 팔꿈치'), 'Rt. Elbow');
    assert.equal(toProperCase('오른 팔꿈치 내측'), 'Rt. Medial Elbow');
