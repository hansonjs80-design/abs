...
export const APP_TABS = [
  ...
  { key: 'shockwave', path: '/shockwave', icon: Zap, label: '충격파/도수 스케줄', shortLabel: '충격파/도수 스케줄', monthLabel: '충격파/도수 스케줄', tabClass: 'top-tab--shockwave' },
  { key: 'shockwave_stats', path: '/shockwave-stats', icon: ClipboardList, label: '충격파 통계', shortLabel: '충격파 통계', monthLabel: '충격파 통계', tabClass: 'top-tab--stats' },
  { key: 'manual_therapy_stats', path: '/manual-therapy-stats', icon: Hand, label: '도수치료 통계', shortLabel: '도수통계', monthLabel: '도수치료 통계', tabClass: 'top-tab--stats' },
